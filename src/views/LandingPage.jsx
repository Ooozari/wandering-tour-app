    ...
    return (
        <div className='flex flex-col gap-10 md:gap-15 lg:gap-20'>
            ...
            <div className="relative">
                ...
                {/* Text */}
                <div className="absolute inset-0 flex flex-col justify-center items-center gap-4 text-white z-10">
                    <h1 className="text-2xl text-center sm:text-3xl md:text-6xl font-extrabold uppercase">Unique, Local, Small <span className='text-Secondary'>Groups</span></h1>
                    <p className="text-md  md:text-lg lg:text-xl">Tours that show you something new.</p>
