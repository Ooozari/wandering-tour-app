        ...
        <>
            <div className='flex md:flex-row flex-col gap-15'>
                ...
                <div className='w-full md:w-[60%] flex flex-col gap-12'>
                            ...
                            <table className="w-full border-collapse">
                                <tbody>
                                    <tr className="border-b">
                                        <td className="p-4">
                                            <Image src={CartItem1} alt="Cart Item 1 Img" className="rounded-xl" />
                                        </td>
                                        <td className="p-4">
                                    ...
                                    <tr className="border-b">
                                        <td className="p-4">
                                            <Image src={CartItem2} alt="Cart Item 2 Img" className="rounded-xl" />
                                        </td>
                                        <td className="p-4">
                                        ...
                                        <td className="p-4">
                                            <div className="flex-1 flex items-center gap-2">
                                                <Button variant="outline" sizeclassName="w-full flex">
                                                    <p onClick={handlepersonCounterDec} className='text-darkGrey text-2xl font-bold cursor-pointer'>-</p>
                                                    <p>{personCounter}</p>
                                                    <p onClick={handlepersonCounterInc} className='text-Secondary text-2xl font-bold cursor-pointer'>+</p>
                                                </Button>
                    ...
                    {/* Coupon Section */}
                    <div className='py-2 px-4 bg-white shadow-lg border border-strokeLight rounded-2xl flex flex-col gap-4'>
