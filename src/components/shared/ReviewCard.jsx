...
function ReviewCard({ msg, name, location }) {
    return (
        <>
        <div className='h-ful'>
<div className="flex flex-col bg-White rounded-3xl shadow-lg px-10 py-[30px] h-full">
            {/* Icon */}
            <div className="flex justify-center mb-4">
                <Review />
            </div>

            {/* Review Message (centered vertically between icon and name) */}
            <div className="flex-1 flex items-center">
                <p className="text-Black text-sm text-center">{msg}</p>
            </div>
