...
function CountryCard({ svgImg, title }) {
    return (
        <div className='flex flex-col items-center justify-center gap-[15px]
            ...
            {/* Icon */}
            <div className="flex items-center justify-center 2xl:w-[80px] 2xl:h-[80px] xl:w-[70px] xl:h-[70px] lg:w-[60px] lg:h-[60px] md:w-[50px] md:h-[50px] w-[40px] h-[40px]">
                {svgImg}
            </div>
