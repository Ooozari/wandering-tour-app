...
function TransparentHeader() {
    ...
    return (
        <div className='absolute top-0 left-0 z-50  flex flex-col md:flex-row justify-between items-center w-full px-4 md:px-[60px] py-4 md:py-[20px] gap-4 md:gap-0'>
            {/* Logo */}
            <div className="relative flex items-center">
                <Link href="/">
                <Image
            ...
            {/* Navbar Links */}
            <ul className='flex flex-wrap justify-center items-center gap-4 text-White text-[14px] md:text-md'>
                <li className={getLinkClasses('/tours')}>
                    <Link href="/tours">TOURS</Link>
                </li>
                <li className={getLinkClasses('/about-us')}>
